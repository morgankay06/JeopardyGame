...
public class Jeopardy{
    ...
    //welcome message
        System.out.println("Hello and welcome to Jeopardy!\nDo not answer in the form of a question and call the clue you want by listing the row (1-5) and then the column(1-5).\nPlease enter your names.");
    ...
    //Category: Synonyms
      ...
      while(i<25 && row!=50){
          if(i%2==0){
              System.out.println(Player1.getName() +": What row would you like to choose (1-5)? Input \"50\" to end.");
              row = input.nextInt();
              if(row==50){
                  break;
                }
              System.out.println("What column would you like to choose (1-5)?");
              col = input.nextInt();
              if(col==50){
                  break;
                }
              while(arr[col-1][row-1]==null){
              ...
              System.out.println(arr[col-1][row-1].getQuestion());
              System.out.println();
          ...
          if(i%2!=0){
              System.out.println(Player2.getName() + ": What row would you like to choose (1-5)? Input \"50\" to end.");
              row = input.nextInt();
              if(row==50){
                  break;
                }
