...
public class Jeopardy{
    public static void main(String[]args){
        ...
        Person user4;
        //welcome message
        System.out.println("Hello and welcome to Jeopardy!\nFor this version, do not answer in the form of a question and call the clue you want by listing the row(0-4) and then the column(0-4).\nPlease enter your names.");
    ...
    //Category: Synonyms
      ...
      System.out.println("Column 0 is Synonyms. Column 1 is E before I. Column 2 is US states. Column 3 is 3 Ses. Column 4 is Planets.");
      ...
      while(i<25 && row!=50){
          if(i%2==0){
              System.out.println("Player One: What row would you like to choose?(0-4) Input \"50\" to end");
              row=input.nextInt();
              if(row==50){
                  break;
              }
              System.out.println("What column would you like to choose?(0-4)Input \"50\" to end");
              col=input.nextInt();
              if(col==50){
                  break;
              }
              ...
              System.out.print(arr[col][row].getQuestion());
              System.out.println("");
              //System.out.println("Enter your answer:");
              answer = user.nextLine();
              if(answer.equalsIgnoreCase(arr[col][row].getAnswer())){
                  Player1.setTotal(Player1.getTotal() + arr[col][row].getWorth());
                  System.out.println("Correct! " + Player1);
                  System.out.println();
                }
                
              else if(!answer.equalsIgnoreCase(arr[col][row].getAnswer())){
                  Player1.setTotal(Player1.getTotal() - arr[col][row].getWorth());
                  System.out.println("Wrong! " + Player1);
                  System.out.println("The answer was "+ arr[col][row].getAnswer());
                  System.out.println();
                }
            }
          if(i%2!=0){
              System.out.println("Player Two: What row would you like to choose?(0-4) Input \"50\" to end");
              row=input.nextInt();
              if(row==50){
                  break;
              }
             ...
             answer = user.nextLine();
              if(answer.equalsIgnoreCase(arr[col][row].getAnswer())){
                  Player2.setTotal(Player2.getTotal() + arr[col][row].getWorth());
                  System.out.println("Correct! " + Player2);
                  System.out.println();
                }
                
              else if(!answer.equalsIgnoreCase(arr[col][row].getAnswer())){
                  Player1.setTotal(Player2.getTotal() - arr[col][row].getWorth());
